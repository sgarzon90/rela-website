export const COLOMBIA = {
  "Amazonas": [
    "Leticia", "Puerto Nariño", "La Chorrera", "La Pedrera", "La Victoria",
    "Miriti-Paraná", "Puerto Alegría", "Puerto Arica", "Puerto Santander", "Tarapacá"
  ],
  "Antioquia": [
    "Abejorral", "Abriaquí", "Alejandría", "Amagá", "Amalfi", "Andes", "Angostura",
    "Anorí", "Anza", "Apartadó", "Arboletes", "Argelia", "Armenia", "Barbosa",
    "Bello", "Betania", "Betulia", "Briceño", "Buriticá", "Cáceres", "Caicedo",
    "Caldas", "Campamento", "Cañasgordas", "Carepa", "Carolina del Príncipe",
    "Caucasia", "Chigorodó", "Cisneros", "Ciudad Bolívar", "Cocorná", "Concepción",
    ...
    "Rionegro", "Sabaneta", "San Andrés de Cuerquia", "San Carlos", "San Francisco",
    ...
    "Támesis", "Tarso", "Titiribí", "Toledo", "Turbo", "Uramita", "Urrao",
  ...
  "Atlántico": [
    ...
    "Sabanalarga", "Santa Lucía", "Santo Tomás", "Soledad", "Suan", "Tubará",
    "Usiacurí"
  ],
  "Bogotá D.C.": ["Bogotá"],
  "Bolívar": [
    ...
    "Mahates", "Margarita", "María la Baja", "Mompox", "Montecristo", "Morales",
  ...
  "Boyacá": [
    ...
    "Campohermoso", "Cerinza", "Chinavita", "Chiquinquirá", "Chíquiza", "Chivor",
    "Ciénega", "Cómbita", "Coper", "Corrales", "Covarachía", "Cubará", "Cucaita",
    "Cuítiva", "Chiscas", "Duitama", "El Cocuy", "El Espino", "Firavitoba",
    "Floresta", "Gachantivá", "Gameza", "Garagoa", "Guacamayas", "Guateque",
    "Guayatá", "Güicán", "Iza", "Jenesano", "Jericó", "La Capilla", "La Uvita",
    "La Victoria", "Labranzagrande", "Macanal", "Maripí", "Miraflores", "Mongua",
    ...
    "Santa Rosa de Viterbo", "Santa Sofía", "Sativanorte", "Sativasur",
    "Siachoque", "Soatá", "Socotá", "Socha", "Sogamoso", "Somondoco", "Sora",
    "Soracá", "Sotaquirá", "Susacón", "Sutamarchán", "Sutatenza", "Tasco",
    "Tenza", "Tibaná", "Tibasosa", "Tinjacá", "Tipacoque", "Toca", "Togüí",
  ...
  "Cauca": [
    ...
    "San Sebastián", "Santa Rosa", "Santander de Quilichao", "Silvia", "Sotará",
  ...
  "Cundinamarca": [
    ...
    "Fusagasugá", "Girardot", "La Mesa", "Agua de Dios", "Albán", "Anapoima",
    "Anolaima", "Apulo", "Arbeláez", "Beltrán", "Bituima", "Bojacá", "Cabrera",
    "Cachipay", "Cajicá", "Caparrapí", "Cáqueza", "Carmen de Carupa",
    "Chaguaní", "Chipaque", "Choachí", "Chocontá", "Cogua", "Cota",
    "Cucunubá", "El Colegio", "El Peñón", "El Rosal", "Fómeque", "Fosca",
    "Funza", "Fúquene", "Gachalá", "Gachancipá", "Gachetá", "Gama",
    "Granada", "Guachetá", "Guaduas", "Guasca", "Guataquí", "Guatavita",
    "Guayabal de Síquima", "Guayabetal", "Gutiérrez", "Jerusalén", "Junín",
    "La Calera", "La Palma", "La Peña", "La Vega", "Lenguazaque", "Machetá",
    "Manta", "Medina", "Nariño", "Nemocón", "Nilo", "Nimaima", "Nocaima",
    ...
    "Silvania", "Simijaca", "Sopó", "Subachoque", "Suesca", "Supatá", "Susa",
    "Sutatausa", "Tabio", "Tausa", "Tena", "Tenjo", "Tibacuy", "Tibirita",
    "Tocaima", "Tocancipá", "Topaipí", "Ubalá", "Ubaque", "Ubaté", "Útica",
    "Venecia", "Vergara", "Vianí", "Villa de San Diego de Ubaté",
  ...
  "Nariño": [
    ...
    "Linares", "Los Andes", "Magüí", "Mallama", "Mosquera", "Nariño",
  ...
  "Putumayo": [
    "Mocoa", "Colón", "Leguízamo", "Orito", "Puerto Asís", "Puerto Caicedo",
  ...
  "Santander": [
    ...
    "Gambita", "Girón", "Guaca", "Guadalupe", "Guapotá", "Guavatá",
  ...
  "Sucre": [
    ...
    "San Pedro", "Sincé", "Sucre", "Tolú", "Tolú Viejo"
  ],
  "Tolima": [
